...
<head>
    ...
    <title>欢迎登陆小米商城后台管理系统@yield('title')</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">小米商城后台管理系统</a>
            </div>
            <!-- /.navbar-header -->
...
<!--   <script src="/admins/bower_components/raphael/raphael-min.js"></script>
    <script src="/admins/bower_components/morrisjs/morris.min.js"></script>
    <script src="/admins/js/morris-data.js"></script>-->
